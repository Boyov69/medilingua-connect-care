...
const Home = () => {
  ...
  return <main className="min-h-screen pt-32 bg-gradient-to-b from-rose-50 via-sky-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 bg-cyan-300">
      <div className="container mx-auto max-w-3xl p-4 text-center">
        ...
        <img src="/placeholder.svg" alt="MediLingua Home" className="mx-auto w-48 md:w-64 mb-8" />
        <div className="mb-16">
          <Link to="/find-doctors" className="bg-gradient-to-r from-primary to-indigo-600 hover:from-primary/90 hover:to-indigo-600/90 text-white px-7 py-3 rounded-full shadow-lg text-lg font-semibold transition-colors inline-block dark:from-blue-600 dark:to-purple-600">
            {findDoctor}
          </Link>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <Card className="bg-gradient-to-br from-sky-50 to-teal-50 shadow-lg border-sky-100 dark:from-gray-800 dark:to-gray-700 dark:border-gray-600">
            ...
            <CardContent className="text-center">
              ...
              <Link to="/find-doctors?availability=available" className="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-sky-500 to-teal-400 text-white rounded-full font-medium hover:from-sky-600 hover:to-teal-500 transition-all shadow-md dark:from-sky-600 dark:to-teal-500 dark:hover:from-sky-700 dark:hover:to-teal-600">
